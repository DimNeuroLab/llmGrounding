...
def build_prompt(input_sample):
    ...
    prompt = f"""I will give you a dialogue from a game of Settlers of Catan, you will need to predict the class of the next utterance
    The admissible classes of utterances, with definition and examples are:\n
    Offer: A proposal to trade resources between players, which isn't related to another offer. Example: Hey anyone have any clay? 
