...
Useful information about when a dialogue act is more likely to be directly after another dialogue act:
- Offer often follows Other. Sometimes it follows Accept, less times it follows Refusal, Counteroffer and Offer.
- Accept several times follows Accept and Counteroffer. A few times follows Offer and rarely follows Other and Refusal.
- Refusal often follows Offer and Refusal. Sometimes it follows Other and Counteroffer, it rarely follows Accept.
- Counteroffer sometimes follows Accept and Counteroffer. Rarely follows Offer, Other and Refusal.
- Other can follow other classes in the dialogue you read, but it never follows the last dialogue act.
