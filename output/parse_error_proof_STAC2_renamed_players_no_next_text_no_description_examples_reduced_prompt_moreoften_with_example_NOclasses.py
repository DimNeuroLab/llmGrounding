...
The classes of the utterances are: "Offer", "Counteroffer", "Accept", "Refusal" and "Other".
...
- After a "Counteroffer" the most likely dialogue act is one among "Accept" or "Refusal" or another "Counteroffer".
Example:
