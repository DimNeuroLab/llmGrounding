...
def build_prompt(input_sample):
    ...
    "Offer: A proposal to trade resources between players, which isn't related to another offer. Example1: Hey anyone have any clay? Example2: Need wood or clay?\n",
    ...
    random.shuffle(classdescriptions)
    
    classdescriptions_text = '\n'.join(classdescriptions)

    classprobs = [
    "After an Offer the most likely dialogue act is Refusal. Example: player_blue: anybody need ore? (Offer) player_red: sry no (Refusal)",
    "After a Counteroffer the most likely dialogue act is one among Accept or Refusal or Counteroffer. Example: player_bird: wheat for clay? (Offer) player_whale: I don't need clay. I can do for wood (Counteroffer) player_bird: I can spare one (Accept) or player_grey: Nope (Refusal) or player_grey: Anything else than wood? (Counteroffer)",
    "After an Accept the most likely dialogue act is another Accept. Example: player_tall: Anyone wants clay? (Offer) player_small: Yes (Accept) player_tall: k (Accept)",
    "After a Refusal the most likely dialogue act is another Refusal. Example: player_Mike: No (Refusal) player_Anna: sry can't (Refusal)",
    "After a Other the most likely dialogue act is Offer. Example: player_dark: ahah (Other) player_light: wheat for me? (Offer)"
]

    random.shuffle(classprobs)
...
How could the dialogue continue, given all the information provided?
